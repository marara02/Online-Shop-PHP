...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=ZCOOL+QingKe+HuangYou&display=swap" rel="stylesh    eet">
...
<div class="main">
    <form name="form" class="form">
        <div class="f">
            ...
            <span id="errorMsg" style="position: absolute; z-index: 9999999999999999;"></span>
</div>
        </div>
    </form>
</div>
